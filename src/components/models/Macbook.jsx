...
Files: macbook.glb [629.72KB] > /Users/jeffsabarman/Documents/Learning/creative_frontend/macbook_gsap_app/public/models/macbook-transformed.glb [627.9KB] (0%)
...
export default function MacbookModel(props) {
  const { nodes, materials } = useGLTF('/models/macbook-transformed.glb')
      const texture = useGLTF('/screen.png')
  return (
